...
const cubeShape = new THREE.BoxBufferGeometry();
const cube = new THREE.Mesh(cubeShape, cubeMaterial);
scene.add(cube); 
generateGalaxy();
// GUI
...
const tick = () => {
    ...
    for(let i = 0; i < parameters.count; i++) {
        ...
        geometry.attributes.position.array[i3+2] =  Math.sin(x + elapsedTime)   ;
    }
